...
name_token = "Req_"
inputAverageArrivalTime = 20.0 # secondi
...
def getServiceTime(nameTask, dictTasks):
   duration=np.random.exponential(getAvgServiceTime(nameTask,dictTasks))
...
def getAvgServiceTime(nameTask, dictTasks):
...
def Tc1_t(c,r):
    duration = getServiceTime("Tc1", dictTasks)
...
def Tn1_t(c,r):
    duration = getServiceTime("Tn1", dictTasks)
    updateReourceUtilizationTime(r, duration)
    updaterRequestUtilizationTimeTaskSeq(c,duration)
...
def Tc2_t(c,r):
    duration = getServiceTime("Tc2", dictTasks)
    updateReourceUtilizationTime(r, duration)
    updaterRequestUtilizationTimeTaskSeq(c,duration)
    return [SimToken(c, delay=duration), SimToken(r,delay=duration)]
...
def Tn2_t(c,r):
    duration = getServiceTime("Tn2", dictTasks)
    updateReourceUtilizationTime(r, duration)
    updaterRequestUtilizationTimeTaskSeq(c,duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Tc3_t(c,r):
    duration = getServiceTime("Tc3", dictTasks)
    updateReourceUtilizationTime(r, duration)
    updaterRequestUtilizationTimeTaskSeq(c,duration)
    return [SimToken(c, delay=duration), SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Tn3_t(c,r):
    duration = getServiceTime("Tn3", dictTasks)
    updateReourceUtilizationTime(r, duration)
    updaterRequestUtilizationTimeTaskSeq(c,duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Tc4_t(c,r):
    duration = getServiceTime("Tc4", dictTasks)
    updateReourceUtilizationTime(r, duration)
    updaterRequestUtilizationTimeTaskSeq(c,duration)
    return [SimToken(c, delay=duration), SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Tn4_t(c,r):
    duration = getServiceTime("Tn4", dictTasks)
    updateReourceUtilizationTime(r, duration)
    updaterRequestUtilizationTimeTaskSeq(c,duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Tc5_t(c,r):
    duration = getServiceTime("Tc5", dictTasks)
    updateReourceUtilizationTime(r, duration)
    updaterRequestUtilizationTimeTaskSeq(c,duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Tn5_t(c,r):
    duration = getServiceTime("Tn5", dictTasks)
    updateReourceUtilizationTime(r, duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Ts1_t(c,r):
    duration = getServiceTime("Ts1", dictTasks)
    updateReourceUtilizationTime(r, duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Tn6_t(c,r):
    duration = getServiceTime("Tn6", dictTasks)
    updateReourceUtilizationTime(r, duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Ts2_t(c,r):
    duration = getServiceTime("Ts2", dictTasks)
    updateReourceUtilizationTime(r, duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Tn7_t(c,r):
    duration = getServiceTime("Tn7", dictTasks)
    updateReourceUtilizationTime(r, duration)
    return [SimToken(c, delay=duration), SimToken(r, delay=duration)]
...
def Ts3_t(c,r):
    duration = getServiceTime("Ts3", dictTasks)
    updateReourceUtilizationTime(r, duration)
    return [SimToken(c, delay=duration),SimToken(r, delay=duration)]
