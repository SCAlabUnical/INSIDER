...
layoutXY = dict()
with open('layout/BeltWasteRecyclingV1.txt') as f:
    lines = f.readlines()
for i in range(1,len(lines)):
    val = lines[i].split(',')
    layoutXY[val[0]] = [ int( val[1]) ,  int( val[2]) ]
...
WorkflowManager.insider_add_event(workflow,[Tn0_p],[Tn0_p,Tc1_p], Tc0_t,
                                  {"name":"Source","type":""})
jsonOut['nodes'].append({"name": "Source",
                         "nameTask": "Tn0",
                         "type": "BEGIN",
                         "start":"Tn0_p",
                         "service":"",
                         ...
                         "y":layoutXY["Source"][1],
                         "description":"Source"})
jsonOut["connections"].append({ "source":"Tn0_p" ,"dest":"Tn0", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn0" ,"dest":"Tn0_p", "probability":1.0  })
jsonOut["connections"].append({ "source":"Tn0" ,"dest":"Tc1_p", "probability":1.0  })
...
jsonOut['nodes'].append({"name": "Camera_acquisition",
                         "nameTask": "Tc1",
                         "type":"COMPUTE",
                         "service":"Cyber physical interface",
                         "flowin":["single", ""],
                         "flowout":["split", "and"],
                         "resource":[str(Tc1_r)],
                         "x":layoutXY["Camera_acquisition"][0],
                         "y":layoutXY["Camera_acquisition"][1],
                         "description":"Camera_acquisition"})
jsonOut["connections"].append({ "source":"Tc1_p" ,"dest":"Tc1", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc1_r" ,"dest":"Tc1", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc1" ,"dest":"Tn1_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc1" ,"dest":"Tn5_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc1" ,"dest":"Tc1_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Tn1_t",
                         "nameTask": "Tn1",
                         "type":"NETWORK",
                         "service":"Streaming protocol",
                         "flowin":["single", ""],
                         "flowout":["single", ""],
                         "resource":[str(Tn1_r)],
                         "x":layoutXY["Tn1_t"][0],
                         "y":layoutXY["Tn1_t"][1],
                         "description":"Tn1_t"})
jsonOut["connections"].append({ "source":"Tn1_p" ,"dest":"Tn1", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn1_r" ,"dest":"Tn1", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn1" ,"dest":"Tc2_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn1" ,"dest":"Tn1_r", "probability":1.0 })
...
WorkflowManager.insider_add_event(workflow,[Tc2_p, Tc1_r], [Tn2_p, Tc1_r], Tc2_t,
                                  {"name":"Image_processing","type":"COMPUTE"})
jsonOut['nodes'].append({"name": "Image_processing",
                         "nameTask": "Tc2",
                         "type":"COMPUTE",
                         "service":"Object classifier",
                         "flowin":["single", ""],
                         "flowout":["single", ""],
                         "resource":[str(Tc1_r)],
                         "x":layoutXY["Image_processing"][0],
                         "y":layoutXY["Image_processing"][1],
                         "description":"Image_processing"})
jsonOut["connections"].append({ "source":"Tc2_p" ,"dest":"Tc2", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc1_r" ,"dest":"Tc2", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc2" ,"dest":"Tn2_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc2" ,"dest":"Tc1_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Tn2_t",
                         "nameTask": "Tn2",
                         "type":"NETWORK",
                         "service":"Streaming protocol",
                         "flowin":["single", ""],
                         ...
                         "y":layoutXY["Tn2_t"][1],
                         "description":"Tn2_t"})
jsonOut["connections"].append({ "source":"Tn2_p" ,"dest":"Tn2", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn2_r" ,"dest":"Tn2", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn2" ,"dest":"Tc3_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn2" ,"dest":"Tn2_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Segmentation",
                         "nameTask": "Tc3",
                         "type":"COMPUTE",
                         "service":"Object classifier",
                         "flowin":["single", ""],
                         "flowout":["split", "and"],
                         "resource":[str(Tc3_r)],
                         "x":layoutXY["Segmentation"][0],
                         "y":layoutXY["Segmentation"][1],
                         "description":"Segmentation"})
jsonOut["connections"].append({ "source":"Tc3_p" ,"dest":"Tc3", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc3_r" ,"dest":"Tc3", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc3" ,"dest":"Tn3_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc3" ,"dest":"Tn6_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc3" ,"dest":"Tc3_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Tn3_t",
                         "nameTask": "Tn3",
                         "type":"NETWORK",
                         "service":"Streaming protocol",
                         "flowin":["single", ""],
                         ...
                         "y":layoutXY["Tn3_t"][1],
                         "description":"Tn3_t"})
jsonOut["connections"].append({ "source":"Tn3_p" ,"dest":"Tn3", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn3_r" ,"dest":"Tn3", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn3" ,"dest":"Tc4_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn3" ,"dest":"Tn3_r", "probability":1.0 })
...
WorkflowManager.insider_add_event(workflow,[Tc4_p, Tc3_r], [Tn4_p, Tn7_p, Tc3_r], Tc4_t,
                                  {"name":"Belt_command","type":"COMPUTE","flow":"And"})
jsonOut['nodes'].append({"name": "Belt_command",
                         "nameTask": "Tc4",
                         "type":"COMPUTE",
                         "service":"Actuation Execution Planner",
                         "flowin":["single", ""],
                         "flowout":["split", "and"],
                         "resource":[str(Tc3_r)],
                         "x":layoutXY["Belt_command"][0],
                         "y":layoutXY["Belt_command"][1],
                         "description":"Belt_command"})
jsonOut["connections"].append({ "source":"Tc4_p" ,"dest":"Tc4", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc3_r" ,"dest":"Tc4", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc4" ,"dest":"Tn4_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc4" ,"dest":"Tn7_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc4" ,"dest":"Tc3_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Tn4_t",
                         "nameTask": "Tn4",
                         "type":"NETWORK",
                         "service":"Streaming protocol",
                         "flowin":["single", ""],
                         ...
                         "y":layoutXY["Tn4_t"][1],
                         "description":"Tn4_t"})
jsonOut["connections"].append({ "source":"Tn4_p" ,"dest":"Tn4", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn4_r" ,"dest":"Tn4", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn4" ,"dest":"Tc5_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn4" ,"dest":"Tn4_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Actuator",
                         "nameTask": "Tc5",
                         "type":"COMPUTE",
                         "service":"Cyber physical interface",
                         "flowin":["single", ""],
                         "flowout":["single", ""],
                         "resource":[str(Tc5_r)],
                         "x":layoutXY["Actuator"][0],
                         "y":layoutXY["Actuator"][1],
                         "description":"Actuator"})
jsonOut["connections"].append({ "source":"Tc5_p" ,"dest":"Tc5", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc5_r" ,"dest":"Tc5", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc5" ,"dest":"Tn8_p1", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tc5" ,"dest":"Tc5_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Tn5_t",
                         "nameTask": "Tn5",
                         "type":"NETWORK",
                         "service":"Streaming protocol",
                         "flowin":["single", ""],
                         ...
                         "y":layoutXY["Tn5_t"][1],
                         "description":"Tn5_t"})
jsonOut["connections"].append({ "source":"Tn5_p" ,"dest":"Tn5", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn5_r" ,"dest":"Tn5", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn5" ,"dest":"Ts1_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn5" ,"dest":"Tn5_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Ts1_t",
                         "nameTask": "Ts1",
                         "type":"STORAGE",
                         ...
                         "y":layoutXY["Ts1_t"][1],
                         "description":"Ts1_t"})
jsonOut["connections"].append({ "source":"Ts1_p" ,"dest":"Ts1", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts1_r" ,"dest":"Ts1", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts1" ,"dest":"Tn8_p2", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts1" ,"dest":"Ts1_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Tn6_t",
                         "nameTask": "Tn6",
                         "type":"NETWORK",
                         "service":"Streaming protocol",
                         "flowin":["single", ""],
                         ...
                         "y":layoutXY["Tn6_t"][1],
                         "description":"Tn6_t"})
jsonOut["connections"].append({ "source":"Tn6_p" ,"dest":"Tn6", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn6_r" ,"dest":"Tn6", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn6" ,"dest":"Ts2_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn6" ,"dest":"Tn6_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Ts2_t",
                         "nameTask": "Ts2",
                         "type":"STORAGE",
                         ...
                         "y":layoutXY["Ts2_t"][1],
                         "description":"Ts2_t"})
jsonOut["connections"].append({ "source":"Ts2_p" ,"dest":"Ts2", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts1_r" ,"dest":"Ts2", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts2" ,"dest":"Tn8_p3", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts2" ,"dest":"Ts1_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Tn7_t",
                         "nameTask": "Tn7",
                         "type":"NETWORK",
                         "service":"Streaming protocol",
                         "flowin":["single", ""],
                         ...
                         "y":layoutXY["Tn7_t"][1],
                         "description":"Tn7_t"})
jsonOut["connections"].append({ "source":"Tn7_p" ,"dest":"Tn7", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn7_r" ,"dest":"Tn7", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn7" ,"dest":"Ts3_p", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn7" ,"dest":"Tn7_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Ts3_t",
                         "nameTask": "Ts3",
                         "type":"STORAGE",
                         "service":"Event storage",
                         "flowin":["single", ""],
                         ...
                         "y":layoutXY["Ts3_t"][1],
                         "description":"Ts3_t"})
jsonOut["connections"].append({ "source":"Ts3_p" ,"dest":"Ts3", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts1_r" ,"dest":"Ts3", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts3" ,"dest":"Tn8_p4", "probability":1.0 })
jsonOut["connections"].append({ "source":"Ts3" ,"dest":"Ts1_r", "probability":1.0 })
...
jsonOut['nodes'].append({"name": "Collector",
                         "nameTask": "Tn8",
                         "type":"END",
                         "service":"",
                         "flowin":["join", "and"],
                         "flowout":["", ""],
                         "resource":[""],
                         "x":layoutXY["Collector"][0],
                         "y":layoutXY["Collector"][1],
                         "description":"Collector"})
jsonOut["connections"].append({ "source":"Tn8_p1" ,"dest":"Tn8", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn8_p2" ,"dest":"Tn8", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn8_p3" ,"dest":"Tn8", "probability":1.0 })
jsonOut["connections"].append({ "source":"Tn8_p4" ,"dest":"Tn8", "probability":1.0 })
...
plt.savefig("./images/BeltWasteRecycling_wait_time_x_workflowV1.png")
...
plt.savefig("./images/BeltWasteRecycling_wait_time_x_taskV1.png")
...
plt.savefig("./images/BeltWasteRecycling_wait_length_x_taskV1.png")
...
plt.savefig("./images/BeltWasteRecycling_cycle_timeV1.png")
...
plt.savefig("./images/BeltWasteRecycling_system_loadV1.png")
...
plt.ylabel("RHO")
plt.savefig("./images/BeltWasteRecycling_RHOV1.png")
...
plt.yticks(np. arange(0, 1.1, step=0.2))
plt.ylabel("RHO")
plt.savefig("./images/BeltWasteRecycling_ResourceUtilizationV1.png")
...
#### Salvo il workflow in formato json
json_file = open("json/BeltWasteRecyclingV1_json.json", "w")
json_file.write(json.dumps(jsonOut, indent=4))
json_file.close()