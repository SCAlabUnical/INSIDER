...
def objective(allocation, visualize=False):
    ...
    insider_simulator=InsiderSimulator(name_token="Req_",inputAverageArrivalTime=inputAverageArrivalTime,SIMULATION_DURATION=6*60*60,name="Taxi")
...
if __name__ == '__main__':
    ...
    for i, maxiter in enumerate( maxiterList):
        ...
        result = differential_evolution( objective, bounds, integrality=(True)*len(bounds), maxiter=maxiter, popsize=1, workers=1, updating='deferred' )
